...
export default function TeacherInteractive() {
  ...
  const teachers = [
    ...
    },
    {
      ...
      avatar: "MC",
      status: "online",
      lastMessage: "Can we discuss the lab schedule?",
      time: "15m ago",
      unread: 0,
    },
    {
      ...
      avatar: "ER",
      status: "away",
      lastMessage: "The experiment results look great",
      time: "1h ago",
      unread: 1,
    },
    {
    ...
    },
    {
      ...
      avatar: "LA",
      status: "online",
      lastMessage: "I loved your presentation today",
      time: "5h ago",
      unread: 0,
    },
  ];
  ...
  const messages = [
    {
      id: 1,
      sender: "them",
      text: "Hi! I was reviewing the curriculum for next semester.",
      time: "10:30 AM",
    },
    {
      id: 2,
      sender: "me",
      text: "Great! What changes are you thinking about?",
      time: "10:32 AM",
    },
    {
      id: 3,
      sender: "them",
      text: "I think we should add more practical sessions for students.",
      time: "10:35 AM",
    },
    {
      id: 4,
      sender: "me",
      text: "That sounds excellent. We could coordinate lab times together.",
      time: "10:37 AM",
    },
    {
      id: 5,
      sender: "them",
      text: "Perfect! Let me know when you're free this week.",
      time: "10:40 AM",
    },
  ];
  ...
  const forums = [
    {
      id: 1,
      title: "Teaching Strategies for Remote Learning",
    ...
    {
      id: 3,
      title: "Sharing Assessment Templates",
  ...
  const events = [
    ...
    {
      id: 2,
      title: "Workshop: Modern Teaching Tools",
      date: "Oct 18, 2025",
      time: "2:00 PM",
      attendees: 25,
      type: "workshop",
