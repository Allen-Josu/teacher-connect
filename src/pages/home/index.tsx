import { BookOpen, Bot, Wifi, Globe, Users, Zap } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                ...
                className="cursor-pointer bg-gradient-to-br from-violet-50 to-purple-50 p-8 rounded-2xl border-t-4 border-violet-500 hover:shadow-2xl transform hover:-translate-y-2 transition-all"
              >
