    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-base sm:text-xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                <span className="hidden sm:inline">AI Teaching Assistant</span>
                <span className="sm:hidden">AI Assistant</span>
              </span>
            </div>
          </div>
          <div className="flex items-center gap-2 sm:gap-3">
            <button className="p-2 hover:bg-white/10 rounded-xl transition-all relative hidden sm:block">
              <Bell className="w-5 h-5" />
              <span className="absolute top-1 right-1 w-2 h-2 bg-pink-500 rounded-full"></span>
            </button>
            <button className="p-2 hover:bg-white/10 rounded-xl transition-all hidden sm:block">
      ...
      <div className="flex pt-16 sm:pt-20">
        ...
        <aside
          ...
          } fixed w-64 sm:w-72 top-16 sm:top-20 left-0 h-[calc(100vh-4rem)] sm:h-[calc(100vh-5rem)] transition-transform duration-300 z-40 overflow-y-auto bg-slate-900/95 backdrop-blur-xl`}
        >
        ...
        <main className="flex-1 p-3 sm:p-6 relative z-10 flex justify-center items-start">
          <div className="w-full max-w-3xl">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              {showLessonPlanForm && (
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-white/20 animate-fade-in">
                  ...
                  <div className="mb-3 sm:mb-4">
                    ...
                    <input
                      ...
                      placeholder="e.g., Fractions, Plant Cell"
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 border-2 border-white/10 rounded-xl text-white placeholder-gray-400 focus:border-purple-400 focus:outline-none text-sm sm:text-base"
                    />
                  </div>
                  ...
                  <div className="mb-4 sm:mb-6">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 border-2 border-white/10 rounded-xl text-white placeholder-gray-400 focus:border-purple-400 focus:outline-none resize-none text-sm sm:text-base"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-500 via-pink-500 to-purple-500 rounded-xl sm:rounded-2xl font-bold text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:shadow-2xl hover:scale-105 disabled:hover:scale-100 flex items-center justify-center gap-2 sm:gap-3"
                  >
                    <Sparkles className="w-5 h-5 sm:w-6 sm:h-6" />
                    <span className="hidden sm:inline">Generate in Chat</span>
              ...
              {/* Chat Messages */}
              <div className="bg-white/10 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-white/20 h-[calc(100vh-280px)] sm:h-[calc(100vh-350px)] flex flex-col overflow-hidden">
                <div className="flex-1 overflow-y-auto p-3 sm:p-6 space-y-3 sm:space-y-4">
                      ...
                      <div
                        className={`max-w-[85%] sm:max-w-3xl ${
                          msg.role === "user"
                            ...
                            : "bg-white/10"
                        } rounded-xl sm:rounded-2xl px-3 sm:px-6 py-3 sm:py-4 relative group`}
                      >
                        ...
                        {msg.role === "assistant" && msg.content && (
                          <button
                            ...
                            className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 p-1.5 sm:p-2 hover:bg-white/10 rounded-lg transition-all"
                            title="Copy"
                          >
                  ...
                  {isStreaming && (
                    <div className="flex justify-start">
                      <div className="bg-white/10 rounded-xl sm:rounded-2xl px-4 sm:px-6 py-3 sm:py-4">
                ...
                <div className="border-t border-white/10 p-3 sm:p-4">
                  {error && (
                    <div className="mb-2 sm:mb-3 p-2 sm:p-3 bg-red-500/20 border border-red-500/50 rounded-xl flex items-center gap-2">
                  ...
                  <div className="flex gap-1.5 sm:gap-2">
                    <input
                      ...
                      className="flex-1 px-3 sm:px-4 py-2.5 sm:py-3 bg-white/5 border-2 border-white/10 rounded-xl text-white placeholder-gray-400 focus:border-purple-400 focus:outline-none text-sm sm:text-base"
                    ...
                    <button
                      ...
                      className="p-2.5 sm:p-3 bg-gradient-to-br from-purple-500 to-pink-500 rounded-xl hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                    >
